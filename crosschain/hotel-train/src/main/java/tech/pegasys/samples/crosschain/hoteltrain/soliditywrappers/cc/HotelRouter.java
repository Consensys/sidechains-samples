...
public class HotelRouter extends CrosschainContract {
    ...
    public byte[] bookRoom_AsSignedCrosschainSubordinateTransaction(BigInteger param0, BigInteger param1, BigInteger param2, final CrosschainContext crosschainContext) throws IOException {
        final Function function = new Function(
                FUNC_BOOKROOM, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(param0), 
                new org.web3j.abi.datatypes.generated.Uint256(param1), 
    ...
    public RemoteFunctionCall<TransactionReceipt> bookRoom_AsCrosschainOriginatingTransaction(BigInteger param0, BigInteger param1, BigInteger param2, final CrosschainContext crosschainContext) {
        final Function function = new Function(
                FUNC_BOOKROOM, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(param0), 
                new org.web3j.abi.datatypes.generated.Uint256(param1), 
