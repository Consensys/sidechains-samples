...
solc $CONTRACTSDIR/CrosschainCoordinationV1.sol --bin --abi --optimize -o $BUILDDIR --allow-paths $PWD/common-solidity/crosschain-precompile-calls/contracts,$PWD/common-solidity/signature-verification/contracts
solc $CONTRACTSDIR/VotingAlgMajorityWhoVoted.sol --bin --abi --optimize -o $BUILDDIR
ls -al $BUILDDIR
